use io; use conv;main(args: int[][]) {i: int = 0;
a: int = 123456789;b: int = 987654321;prime: int = 4725067;
biggerPrime: int = 842580419;pi: int = 314159265359;e: int = 271828182845;
array: int[] = "Some string goes here";counter: int = 0;
while (i < 10000000) {
...
i = i + 1;counter = counter + f - g + h - j + k - l + m - n + o - p;}
